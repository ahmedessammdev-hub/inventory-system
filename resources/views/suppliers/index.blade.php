    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 flex justify-between items-center">
                <div>
                    <h2 class="text-3xl font-bold text-gray-800">Suppliers</h2>
                    <p class="text-gray-600 mt-1">Manage your supplier information</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <x-supplier-stat-card
                title="Complete Info"
                :value="$suppliersWithCompleteInfo"
                color="purple">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Search and Filters -->
        <x-supplier-filters :route="route('suppliers.index')" />
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($suppliers as $supplier)
                            <x-supplier-table-row :supplier="$supplier" />
                        @empty
                            <tr>
